...
router.get("/getUserByPhone/:phoneNumber", (req, res) => {
  UserController.getInfoByPhone(req, res);
});
...
router.post("/change-password-security/:id", (req, res) => {
  UserController.Action.changePasswordSecurity(req, res);
});
...
// Lấy tổng âm của 1 user
router.get("/getAllProfitUser/:id", (req, res) => {
  UserController.getAllProfitUser(req, res);
});
