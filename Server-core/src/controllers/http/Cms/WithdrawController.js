    ...
    try {
      ...
      if (!!page && !!kmess) {
        ...
        let match = {
          ...
          ...(req.query.username && { "$userInfo.username$": { [Op.like]: `%${req.query.username}%` } }),
          ...(req.query.bankName && { bankName: { [Op.like]: `%${req.query.bankName}%` } }),
          ...(req.query.bankProvide && { bankProvide: { [Op.like]: `%${req.query.bankProvide}%` } }),
          ...(req.query.bankNumber && { bankNumber: { [Op.like]: `%${req.query.bankNumber}%` } }),
          ...(req.query.transId && { transId: req.query.transId }),
        ...
        if (!!req.query.username) {
          match["$userInfo.username$"] = { [Op.like]: `%${req.query.username}%` };
        }
        ...
        const total = await BankHistoryModel.count({
          where: match,
          include: [{
            model: UserModel,
            as: 'userInfo',
